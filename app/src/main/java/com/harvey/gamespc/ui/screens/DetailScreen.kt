...
fun DetailScreen(
    ...
    if (currentItem == null) {
        ...
        Column(
            ...
            // Autor y contador de visitas (si existen en la base de datos)
            val authorName = currentItem.authorName
            val viewsCount = currentItem.viewsCount
            if (!authorName.isNullOrBlank() || !viewsCount.isNullOrBlank()) {
                Row(
